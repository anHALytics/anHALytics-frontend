...
//
//
//    piece += '<div class="col-md-1"><a id="close-disambiguate-panel" style="display:none" onclick=\'$("#disambiguation_panel").hide()\'><span class="glyphicon glyphicon-remove"></span></a></div>';
...
var getPieceShowexpandNERD = function (jsonObject) {
    ...
    piece += '</div>';
    piece += '<div class="col-md-1"><a id="close-disambiguate-panel" onclick=\'$("#disambiguation_panel").hide()\'><span class="glyphicon glyphicon-remove"></span></a></div>';
